...
const Analytics = () => {
  ...
  const userGrowthData = {
    labels: currentAnalytics.userGrowth.labels,
    datasets: [
      {
        label: 'New Users',
        data: currentAnalytics.userGrowth.data,
    ...
    datasets: [
      {
        ...
        data: currentAnalytics.engagementMetrics.dailyActiveUsers,
  ...
  const deviceData = {
    ...
    datasets: [
      {
        data: [
          currentAnalytics.deviceBreakdown.mobile,
          currentAnalytics.deviceBreakdown.desktop,
          currentAnalytics.deviceBreakdown.tablet
        ],
        backgroundColor: [
          'rgba(59, 130, 246, 0.8)',
          'rgba(16, 185, 129, 0.8)',
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold">{currentAnalytics.totalUsers.toLocaleString()}</p>
              <p className="text-blue-100 text-sm mt-1">
                +{currentAnalytics.newUsers} new this period
              </p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold">{currentAnalytics.activeUsers.toLocaleString()}</p>
              <p className="text-green-100 text-sm mt-1">
                {Math.round((currentAnalytics.activeUsers / currentAnalytics.totalUsers) * 100)}% of total
              </p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold">{currentAnalytics.pageViews.toLocaleString()}</p>
              <p className="text-purple-100 text-sm mt-1">
                Avg: {currentAnalytics.avgSessionDuration}
              </p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold">{currentAnalytics.conversionRate}%</p>
              <p className="text-orange-100 text-sm mt-1">
                Bounce: {currentAnalytics.bounceRate}%
              </p>
            </div>
