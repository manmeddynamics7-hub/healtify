              ...
              <AnimatePresence>
                {showProfileMenu && (
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 w-64 bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 overflow-hidden"
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute top-14 sm:top-16 right-0 w-72 sm:w-80 h-full bg-white/95 backdrop-blur-md border-l border-white/20"
            >
